package com.fabio.workshopmongo.config;
...
import com.fabio.workshopmongo.dto.AuthorDTO;
import com.fabio.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post2 = new Post(null, sdf.parse("21/05/2018"), "Bom dia!" , "Acordei feliz hoje!", new AuthorDTO(maria));
